...
namespace Infrastraction.Migrations.AppDp
{
    public partial class UserEntty : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockHolder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockHolder_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockHolder_Stock_StockId",
                        column: x => x.StockId,
                        principalTable: "Stock",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockHolder_AppUserId",
                table: "StockHolder",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StockHolder_StockId",
                table: "StockHolder",
                column: "StockId");
        }
